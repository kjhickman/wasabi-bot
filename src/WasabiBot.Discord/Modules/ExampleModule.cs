...
using WasabiBot.Discord.Attributes;
...
public class ExampleModule : InteractionModuleBase<SocketInteractionContext>
{
    ...
    {
        // You can create command choices either by using the [Choice] attribute or by creating an enum. Every enum with 25 or fewer values will be registered as a multiple
        // choice option
