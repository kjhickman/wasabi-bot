...
namespace VinceBot.Terraform;

internal class VinceBotStack : TerraformStack
{
    public VinceBotStack(Construct scope, string id, EnvironmentVariables vars) : base(scope, id)
    {
        ...
        var lambdaEnvironmentVars = new Dictionary<string, string>
        {
            ...
            { nameof(vars.DISCORD_DEFERRED_EVENT_QUEUE_URL), vars.DISCORD_DEFERRED_EVENT_QUEUE_URL },
